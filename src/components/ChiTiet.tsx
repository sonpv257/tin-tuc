    ...
    <>  
      ...
      {!chiTiet ? (  
        ...
        <Box sx={{ maxWidth: 900, margin: "0 auto", padding: 2 }}>  
          ...
          {chiTiet.tomTat && (  
            <Paper sx={{ padding: 2, marginBottom: 3, backgroundColor: "#f9f9f9" }}>  
          ...
          {chiTiet.nguonTin && (  
            <Typography variant="body2" sx={{ marginBottom: 2 }}>  
              <strong>  
                Nguồn tin:{" "}  
                <a href={chiTiet.nguonTin} target="_blank" rel="noopener noreferrer">  
                  {chiTiet.nguonTin}  
                </a>  
              </strong>  
            </Typography>  
          ...
          {chiTiet.fileDinhKem && (  
            <Typography variant="body2" sx={{ marginBottom: 2 }}>  
              ...
              <a href={chiTiet.fileDinhKem} target="_blank" rel="noopener noreferrer">  
                Tải xuống  
              </a>  
            </Typography>  
          )}  
